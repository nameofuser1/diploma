...
\include{Dissertation/analogues}			% Глава 0
\include{Dissertation/ForwardKinematics}	% Глава 1
\include{Dissertation/InverseKinematics}	% Глава 2
\include{Dissertation/PathPlanning}    		% Глава 3
\include{Dissertation/TrajectoryPlanning}	% Глава 4
\include{Dissertation/ROS_RoboticsControl}		% Глава 5
\include{Dissertation/ROS_EnvironmentCreation}	% Глава 6
